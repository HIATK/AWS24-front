...
const API_URL = 'http://ec2-43-201-54-252.ap-northeast-2.compute.amazonaws.com:5000/api/member';
...
export const login = async (username: string, password: string) => {
    try {
      const response = await axios.post('http://ec2-43-201-54-252.ap-northeast-2.compute.amazonaws.com:5000/api/login', 
        { username, password },
        { withCredentials: true }
      );
