      ...
      <form onSubmit={handleSubmit} className={styles.formContainer}>
        ...
        <div className={styles.socialLogin}>
          ...
          <div className={styles.icons}>
            <a href='https://dev.moviepunk.p-e.kr/oauth2/authorization/kakao'>
              <Image src={kakao} alt='KAKAO' />
            </a>
            <Link href='https://dev.moviepunk.p-e.kr/oauth2/authorization/google'>
              <Image src={google} alt='Google' />
            </Link>
            <Link href='https://dev.moviepunk.p-e.kr/oauth2/authorization/naver'>
